        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a href="#pricing">
                <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-dark-800">
                  View Pricing
                </Button>
              </a>
            </div>
          ...
          <div className="relative">
            <div className="bg-dark-700 rounded-2xl p-8 shadow-2xl">
              <div className="bg-dark-800 rounded-xl p-6">
                ...
                <div className="text-center mt-4">
                  <span className="text-xs text-gray-500">Powered by DojoCountdown</span>
                </div>
              </div>
            </div>
            {/* Decorative elements */}
